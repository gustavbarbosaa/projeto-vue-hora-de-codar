    ...
    <div>
        <form id="burguer-form" @submit="createBurguer">
            <div class="input-container">
                ...
                <input type="text" name="nome" id="nome" v-model="nome" placeholder="Informe o seu nome">
            </div>
            <div class="input-container">
            ...
            <div class="input-container">
                <button class="submit-btn" type="submit">Criar o seu Burguer</button>
            </div>
        </form>
    </div>
  </div>
